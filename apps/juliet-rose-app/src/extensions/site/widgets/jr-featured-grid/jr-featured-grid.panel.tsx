          ...
          fields: [
            {
              ...
              kind: 'text',
              help: 'Comma-separated slugs of the treatments shown in this grid, e.g. swedish-massage, microneedling. Leave empty to feature treatments flagged in the Treatments collection.',

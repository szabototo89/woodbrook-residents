...
test('event timeline groups Dublin event dates into this week, next week, and later', () => {
...
test('event timeline uses Monday-based Irish weeks across month boundaries', () => {
  const groups = groupEventsByTimeline(
    [
...
test('event timeline keeps older published dates clearly separate from upcoming events', () => {
  const groups = groupEventsByTimeline(
    [

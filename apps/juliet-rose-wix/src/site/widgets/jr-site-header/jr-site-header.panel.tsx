          ...
          fields: [
            {
              ...
              label: 'Active page',
              kind: 'choice',
              help: 'Highlights the matching navigation item while visitors browse. Choose Automatic to detect it from the page URL.',
              options: [
                { id: '', value: 'Automatic' },
                { id: '/', value: 'Home' },
            ...
            },
            {
              ...
              label: 'Brand title',
              kind: 'text',
              help: 'Studio name shown in the header next to the logo, e.g. Juliet Rose.',
            },
            {
              key: 'brand-subtitle',
              label: 'Brand subtitle',
              kind: 'text',
              help: 'Small descriptor under the studio name, e.g. Beauty Studio.',
            },
          ],
        },
        {
          ...
          fields: [
            ...
            bookingLinkField('booking-url'),
            {
              ...
              label: 'Booking label',
              kind: 'text',
              help: 'Text on the header button that takes visitors to booking.',
            },
          ],
        },
      ]}

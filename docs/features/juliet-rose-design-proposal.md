...
- The homepage leads with personalised skincare and calm, expert care.
...
- Desktop and mobile layouts preserve readable content, visible calls to
  action, and usable controls without horizontal page overflow.

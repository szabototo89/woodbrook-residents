...
3. show clear ways to participate, contribute, or raise a concern;
4. make a growing neighbourhood feel connected to Shankill and to itself;
5. keep a transparent record of changes and next steps.

Transport belongs inside that system as one topic among housing, green space, events, services, and community activity.

## Research sources and translation

- [NewsKit typography presets](https://www.newskit.co.uk/theme/presets/typography-presets/) separate expressive editorial display roles from practical utility roles. Concept 01 uses that tension to feel like a useful neighbourhood publication rather than an institutional portal.
...
## Concept 01 — The Neighbourhood Journal

**Idea:** Woodbrook as a small, trusted local publication that also helps people act.

- Editorial hierarchy and mixed serif/sans typography.
- A morning-edition structure: lead story, diary, notice desk, and subject index.
- Restrained Atlantic, heather, and leaf colour on a clear paper surface.
- Best when trust, explanation, and local storytelling should lead.

## Concept 02 — Common Ground

**Idea:** Woodbrook as a welcoming shared space organised around resident participation.

- Soft, generous modules and conversational prompts.
- Resident jobs lead: know, join, shape, and raise.
- Community activity is presented before projects or institutions.
- Best when participation and neighbour-to-neighbour usefulness should lead.

## Concept 03 — Coast & Canopy Field Notes

**Idea:** Woodbrook as an evolving place between sea and hills, documented by its residents.

- A landscape-inspired composition without tourism branding.
...
Choose based on the system that could carry years of mixed local content—not the most decorative first screen.

- Which one feels most resident-owned?
- Which one makes the purpose immediately obvious?
- Which one balances information and participation best?
- Which one still feels recognisably Woodbrook without leaning on transport?
- Which one could accommodate serious updates and friendly community activity equally well?
